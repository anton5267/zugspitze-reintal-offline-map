...
{leaflet_css}
  ...
  <style>
    ...
    .offline-status {{
      position: fixed; z-index: 9998; top: 10px; right: 10px; max-width: 360px;
    ...
    @media (max-width: 760px) {{
      ...
      .offline-status {{ display: none; top: auto; left: 8px; right: 8px; bottom: 150px; max-width: none; border-radius: 8px; }}
